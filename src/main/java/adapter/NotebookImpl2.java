...
public class NotebookImpl2 implements Notebook2 {

    List<Node> nodeList = new ArrayList<>();

    @Override
    public void createNote(String title, String content, String recipient) {
        nodeList.add(new Node(title, content, recipient));
    }
